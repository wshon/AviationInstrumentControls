/*****************************************************************************/
/* Project  : AvionicsInstrumentsControls                                  */
...
{
    public partial class InstrumentControl : System.Windows.Forms.UserControl
    {
        ...
        internal void DisplayRoundMark(PaintEventArgs pe, Image imgMark, InstrumentControlMarksDefinition insControlMarksDefinition, Point ptImg, int radiusPx, Boolean displayText, float scaleFactor)
        {
            Double alphaRot;
            int textBoxLength;
